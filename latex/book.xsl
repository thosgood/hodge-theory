...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="f:taxon[text()='Principle']">
    <xsl:text>principle</xsl:text>
  </xsl:template>

  <xsl:template match="f:taxon[text()='Translation']">
    <xsl:text>translation</xsl:text>
  </xsl:template>

  <xsl:template match="f:taxon[text()='Dictionary']">
    <xsl:text>dictionary</xsl:text>
  </xsl:template>

  <xsl:template match="f:taxon[text()='Condition']">
    <xsl:text>condition</xsl:text>
  </xsl:template>

  <xsl:template match="f:taxon[text()='Footnote']">
    <xsl:text>footnote</xsl:text>
  </xsl:template>

  <xsl:template match="f:taxon[text()='Property']">
    <xsl:text>property</xsl:text>
  </xsl:template>

  <xsl:template match="f:taxon[text()='Reminder']">
    <xsl:text>reminder</xsl:text>
  </xsl:template>

  <xsl:template match="f:taxon[text()='Hypothesis']">
    <xsl:text>hypothesis</xsl:text>
  </xsl:template>

  <xsl:template match="f:taxon[text()='Examples']">
  ...
  <xsl:template match="f:taxon[text()='Variant']">
  ...
  <xsl:template match="f:taxon[text()='Terminology']">
  ...
  <xsl:template match="f:taxon[text()='Item']">
  ...
  <xsl:template match="f:resource-source[@part='preamble']" />
